        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {pendingAction === 'full' && (
                <>
                  Esta ação irá buscar todos os dados da API SOC e sincronizar no banco de dados local. Isso pode levar
                  alguns minutos dependendo da quantidade de dados.
                  <br />
                  <br />A sincronização seguirá a ordem: Empresas → Unidades → Setores → Cargos → Hierarquias.
                </>
              )}
              ...
              {pendingAction === 'hierarchies' && (
                <>
                  Esta ação irá processar as hierarquias e ajustar os relacionamentos entre empresas, unidades, setores
                  e cargos.
                  <br />
                  <br />
